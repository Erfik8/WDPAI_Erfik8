<section class="information-block <?php echo is_null($main_product) ? 'disabled' :"" ?>" id="product-description">
    <img src="<?php echo is_null($main_product) ? '' : $main_product->getLogoLink() ?>" alt="sloik" class="product-image">
    ...
    <h3>Producent: <?php echo is_null($main_product) ? '' : $main_product->companyObject->getName()?></h3>
